...
/** Parses a JSON string s and represent its content using structered EmacsScript Objects 
 *  Note : this is a rather naive parser that assumes that no "}" appear within a string 
 *		   and that strings do not contain escape characaters
 *          - Sequences are converted to EmacsScript Arrays
 * 			- Structures are converted to EmacsScript Objects
 * @param {string} input string describing a JSON object
 * @return {Object} an EmacsScript Object corresponding to the input string
 */
