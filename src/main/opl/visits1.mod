...
dvar interval espacementIntervals[espac in contraintes] in nurses.inf..nurses.sup size espac.duree2; 
dvar interval transDonnees in rangeMinutes size duree_transmission;

// 定义 step function for patient
...
execute{
    ...
    outputPath =  "../../../results/" + instance.name +"_visits1.dat";
